...
export const DiscordIcon: React.FC<{ className?: string }> = ({ className = "w-4 h-4" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M18 6h0a14.5 14.5 0 0 0-4-1.25 10.3 10.3 0 0 0-.5 1 14.2 14.2 0 0 0-3 0 10.3 10.3 0 0 0-.5-1A14.5 14.5 0 0 0 6 6a15.8 15.8 0 0 0-3 9.5 14.6 14.6 0 0 0 4.5 2.25 11 11 0 0 0 1-1.5 9.5 9.5 0 0 1-1.5-.75.3.3 0 0 1 0-.5 9.8 9.8 0 0 0 7 0 .3.3 0 0 1 0 .5 9.5 9.5 0 0 1-1.5.75 11 11 0 0 0 1 1.5A14.6 14.6 0 0 0 21 15.5 15.8 15.8 0 0 0 18 6z" />
